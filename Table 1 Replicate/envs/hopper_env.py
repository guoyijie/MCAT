...
class HopperEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self, data_types, seed):
        ...
        mujoco_env.MujocoEnv.__init__(self, '%s/assets/hopper.xml'%self.dir_path, 4)
        if 'size' in self.data_type:
            mujoco_env.MujocoEnv.__init__(self, '%s/assets/hopper/hopper_%s.xml'%(self.dir_path, self.data_type), 4)
